...
$(document).ready(function () {
  ...
  const sizeOfColor=canvasSize/numberOfPaletteColors;
  ...
  if(availableColors.length>0){
    $(".wrapper").append('<div class="buttomPicker"></div>');
  ...
  for (let i = 0; i < Math.pow(paletteColors.length,2); i++) {
    $(".modalColor").append(`<div class="colorPixel" id="colorPixel${i+1}" tabIndex="${i+1}" style="background-color:${paletteColors[i]};"></div>`);    
  }
